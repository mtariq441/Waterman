        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-1 text-muted-foreground" data-testid="text-hours">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <a
                  href="tel:3219511303"
                  className="flex items-center gap-2 text-muted-foreground hover-elevate p-2 rounded-md"
