...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-[600px] lg:min-h-[700px] flex items-center">
      ...
      <div className="relative container mx-auto px-4 py-20">
        <div className="max-w-3xl text-white">
          ...
          <p className="text-lg md:text-xl mb-8 text-white/95" data-testid="text-hero-subtitle">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              <a href="tel:3219511303" className="flex items-center gap-2">
